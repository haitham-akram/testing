...
{{--           {{__('messages.title')}}--}}
{{--        </div>--}}
{{--        <form method="post" action="{{\LaravelLocalization::localizeURL('offer/store') }}">--}}
{{--            @csrf--}}
...
{{--                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="{{__('messages.Name')}}"--}}
{{--                       name="name">--}}
{{--                @error('name')--}}
...
{{--            </div>--}}
{{--            <div class="form-group">--}}
{{--                <label for="exampleInputPassword1">{{__('messages.Details')}}</label>--}}
{{--                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="{{__('messages.Details')}}" name="details">--}}
{{--                @error('details')--}}
{{--                <small  class="form-text text-danger">{{$message}}</small>--}}
{{--                @enderror--}}
{{--            </div>--}}
...
<div class="flex-center position-ref full-height">
    <div class="content">
        ...
        <form method="post" action="{{\LaravelLocalization::localizeURL('offer/store') }}" enctype="multipart/form-data">
            @csrf
            @if(Session::has('success'))
                <div class="alert alert-success" role="alert">
                    {{Session::get('success')}}
